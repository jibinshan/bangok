  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center bg-[#131313]">
      <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 py-44">
        <h3 className="font-montserrat mb-8 text-center text-sm font-[400] uppercase tracking-[1.98px] text-[#DCDCDC]">
          explore menu
        </h3>
        <div className="relative mb-14 mt-20 flex h-full w-full flex-col justify-between gap-12 px-4 md:flex-row md:gap-20">
          <h2 className="font-montserrat absolute -top-28 left-[5%] mt-5 text-7xl font-[400] text-[#262626] md:left-[15%] md:text-8xl">
            Bangkok
          </h2>
          <div className="z-10 mt-0 flex h-full w-full justify-center md:mt-12 md:w-1/3">
            <Image
              src="/images/home/explore-menu/1.jpg"
              width={435}
              height={319}
              alt="1"
          ...
          <div className="z-10 flex h-full w-full justify-center md:w-1/3">
            <Image
              src="/images/home/explore-menu/2.jpg"
              width={365}
              height={495}
              alt="1"
          ...
          <div className="z-10 mt-0 flex h-full w-full justify-center md:mt-40 md:w-1/3">
            <Image
              src="/images/home/explore-menu/3.jpg"
              width={439}
              height={320}
              alt="1"
          ...
          <h2 className="font-montserrat absolute -bottom-5 right-[25%] z-20 text-8xl font-[400] text-[#FBF5DC] md:text-9xl">
            Menu
          </h2>
        </div>

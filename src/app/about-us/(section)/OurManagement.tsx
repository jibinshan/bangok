        ...
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-[#050505] md:flex-row lg:px-24 lg:py-20">
          ...
          <div className="flex h-full w-full flex-col items-center gap-[2.5rem] p-6 md:w-1/2 md:items-start lg:ml-24">
            <p className="max-w-[450px] text-center font-light leading-[160%] text-[#C1B6A6] md:text-start">
              Welcome to Bangkok. From the very beginning, our vision was to
              ...
              you. Each cut of beef is hand-selected for its quality, each dish
              crafted with care, and every detail of your experience
              ...
              <br />
              <br />
              At Bangkok, we believe dining should be more than just a meal—it
              ...
              magic for you. We look forward to making every visit to Bangkok as

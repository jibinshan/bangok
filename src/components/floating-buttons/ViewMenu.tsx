...
const ViewMenu = ({ }) => {
  ...
  return (
    <Button
      asChild
      className="table-button z-50 flex aspect-square h-24 flex-col items-center justify-center rounded-full bg-[#1D1D1D] px-0 py-0 text-center text-xs uppercase text-[#fed728] hover:bg-[#1D1D1D]"
    >
      <Link href="/table-booking">
        <Icons.dining color="#fed728" />
        Table
        <br />
        Booking
      </Link>
